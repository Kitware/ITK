...
public:
  ...
  // TODO: Enable for backward compatibility using File Enum = IOFileEnum; // For backward compatibility
  ...
  // TODO: Enable for backward compatibility using FileMode Enum = IOFileModeEnum; // For backward compatibility
  ...
  // TODO: Enable for backward compatibility using ByteOrder Enum = IOByteOrderEnum; // For backward compatibility
